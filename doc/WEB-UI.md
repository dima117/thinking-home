...
Виджеты - это элементы управления, которые могут быть добавлены на стартовую страницу. Через специальный редактор можно настраивать, набор виджетов, который должен отображаться на стартовой странице, и их параметры. Например, вы можете добавить виджет отображения температуры и указать для него параметр - датчик температуры, с которого нужно брать информацию.
